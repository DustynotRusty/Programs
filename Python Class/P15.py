# A Python program to create a horizontal scroll bar and attach it to a
# Textwidget to view the text from left to right
...
class MyScrollbar:
    ...
    def __init__(self, root):
        ...
        for i in range(50):
            self.t.insert(END, "Thy have summoned me!!! \n ")
